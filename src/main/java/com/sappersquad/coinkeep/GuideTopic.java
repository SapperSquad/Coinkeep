...
public record GuideTopic(String id, String title, Item icon, List<String> lines) {
    ...
    public static final List<GuideTopic> ALL = List.of(
            ...
            new GuideTopic("custom", "Make It Your Own", Items.ANVIL, List.of(
                    ...
                    "",
                    "#Adding something",
                    "Hold the item and type /coinkeep shop add <price>. That is the whole thing.",
                    "It lists exactly what you are holding - the stack size, the custom name, and any enchantments - so a named, enchanted sword sells as that sword.",
                    "Add /coinkeep shop add <price> <tab> to choose which tab it lands in.",
                    "",
                    "#Changing prices",
                    "/coinkeep shop price <id> <amount> sets what something costs.",
                    "/coinkeep shop sellprice <id> <amount> sets what it pays when sold. Set it to 0 to go back to the automatic 40%.",
                    "Start typing an id and press Tab - the game will complete it for you.",
                    "",
                    "#Removing and undoing",
                    "/coinkeep shop remove <id> takes something out of the shop.",
                    "/coinkeep shop restore <id> puts it back exactly as it was, and /coinkeep shop restoreall undoes every change you have made.",
                    "Nothing is ever destroyed - removing only hides an entry, so you can always change your mind.",
                    "",
                    "#One rule",
                    "You cannot set a sell price at or above what one costs to buy. That would let anyone buy an item and sell it straight back for free money, which would end the economy in an afternoon.",
            ...
            new GuideTopic("reference", "Keys & Commands", Items.COMPASS, List.of(
                    ...
                    "",
                    "#Operator commands",
                    "/coinkeep shop add <price> - list the item you are holding",
                    "/coinkeep shop price <id> <amount> - change what it costs",
                    "/coinkeep shop remove <id> - take it out of the shop",
                    "/coinkeep shop list - see every tab and id",
                    "See the Make It Your Own page for all of them.",
                    "",
                    "#Tips",
